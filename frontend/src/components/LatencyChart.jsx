...
const OPTS = {
  ...
  plugins:{
    ...
    tooltip:{backgroundColor:"#111418",borderColor:"#2a3140",borderWidth:1,titleColor:"#c8d4e0",
      bodyColor:"#6b7f96",titleFont:{family:"IBM Plex Mono",size:11},bodyFont:{family:"IBM Plex Mono",size:11},
...
export default function LatencyChart({history}){
  ...
  useEffect(()=>{
    ...
    c.data.datasets[0].data=history.p95;
    c.data.datasets[1].data=history.p99;
    c.update("none");
  },[history]);
